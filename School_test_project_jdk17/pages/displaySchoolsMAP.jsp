 ...
 <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
		...
		function loadSchoolsList(page = 1) {
            ...
            alert("Select City lat and longit"+cityLatt+"long"+cityLongit);
                    
                               
            var SearchText = schoolTypeSelected+ " Schools in "+ citySelectedValue +", "
            					+distSelectedValue + "," + stateSelectedValue;
                 
            if(cityDropdown.selectedIndex != 0){  
			$.ajax({
                url: 'fetchSchoolsMAP_bak.jsp',
                type: 'GET',
...
<div class="container">
    ...
    <div class="cs-div-right">
		<div class="cs-div-right-up">
			<button class="sc-btn" id = "CBSE" onclick="setSchoolTypeSelected(this)">
				 CBSE
			</button>
			<button class="sc-btn" id="IGCSE" onclick="setSchoolTypeSelected(this)">
				 IGCSE
			</button>
			<button class="sc-btn" id="ICSE" onclick="setSchoolTypeSelected(this)">
				 ICSE
			</button>
			<button class="sc-btn" id="GOVERNMENT" onclick="setSchoolTypeSelected(this)">
				 GOVT
			</button>
		</div>
